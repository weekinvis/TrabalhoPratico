...
public class Professor extends Pessoa implements IdentificavelMatricula {
    ...
    Professor(String nome, String cpf, String email, String endereco, LocalDate nascimento, String matricula, String formacao) {
    ...
    public boolean equals(Professor p) {
        return (this == p) || (p.getMatricula().equals(this.getMatricula()));
    }
